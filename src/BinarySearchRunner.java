public class BinarySearchRunner {
    public static void main(String[] args) {
        ...
        int idx3 = BinarySearch.iterativeNonRecursiveBinarySearch(arr, 12);
        int idx4 = BinarySearch.recursiveBinarySearch(arr, 0, 14, 12);
        System.out.println(idx3);
        System.out.println(idx4);
        System.out.println("---------");

        idx3 = BinarySearch.iterativeNonRecursiveBinarySearch(arr, 55);
        idx4 = BinarySearch.recursiveBinarySearch(arr, 0, 14, 55);
        System.out.println(idx3);
        System.out.println(idx4);
        System.out.println("---------");
    }
